...
export const data1 = {
    firstStep: "1111-auth",
    workflows: {
        "1111-auth": { id: "1111-auth", name: "Authorize", type: WorkflowStepType.AUTHORIZE, children: ["1111-decision"] },
        "1111-decision": { id: "b1fe", name: "Decision", type: WorkflowStepType.DECISION, children: ["3902", "e5d2"] },
        "3902": { id: "3902", name: "Human", type: WorkflowStepType.TRANSLATION, children: ["2910"] },
        "e5d2": { id: "e5d2", name: "MachineMachineMachine", type: WorkflowStepType.TRANSLATION, children: ["3bb4"] },
        "2910": { id: "2910", name: "Edit", type: WorkflowStepType.POST_TRANSLATION, children: ["3bb4"] },
        "3bb4": { id: "3bb4", name: "Review", type: WorkflowStepType.REVIEW, children: ["51fa"] },
        "51fa": { id: "51fa", name: "Published", type: WorkflowStepType.PUBLISH, children: [] }
    }
...
export const data12 = {
    firstStep: "b1fe-auth",
    workflows: {
        "b1fe-auth": { id: "b1fe-auth", name: "Authorize", type: WorkflowStepType.AUTHORIZE, children: ["b1fe"] },
        "b1fe": { id: "b1fe", name: "Decision", type: WorkflowStepType.DECISION, children: ["3bb4"] },
        "3bb4": { id: "3bb4", name: "Review", type: WorkflowStepType.REVIEW, children: ["51fa"] },
        "51fa": { id: "51fa", name: "Published", type: WorkflowStepType.PUBLISH, children: [] }
    }
}
...
export const data2 = {
    ...
    workflows: {
        "b1fe-auth": { id: "b1fe-auth", name: "Authorize", type: WorkflowStepType.AUTHORIZE, children: ["b1fe"] },
        "b1fe": { id: "b1fe", name: "Decision", type: WorkflowStepType.DECISION, children: ["3902", "e5d2"] },
        "3902": { id: "3902", name: "Human", type: WorkflowStepType.TRANSLATION, children: ["2910"] },
        "e5d2": { id: "e5d2", name: "Machine", type: WorkflowStepType.TRANSLATION, children: ["e5d3"] },
        "e5d3": { id: "e5d3", name: "Machine2", type: WorkflowStepType.TRANSLATION, children: ["3bb4"] },
        "2910": { id: "2910", name: "Edit", type: WorkflowStepType.POST_TRANSLATION, children: ["3bb4"] },
        "3bb4": { id: "3bb4", name: "Review", type: WorkflowStepType.REVIEW, children: ["51fa"] },
        "51fa": { id: "51fa", name: "Published", type: WorkflowStepType.PUBLISH, children: [] }
    }
