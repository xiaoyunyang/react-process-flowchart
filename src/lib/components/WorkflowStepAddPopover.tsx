...
const WorkflowStepAddPopover = ({
    ...
    <div style={{
        position: "absolute", left, top, zIndex: 4
    }}
    >
        <div style={{
            width: 300, height: 20, backgroundColor: "red", color: "white"
        }}
        >
            <p>{`tetheredNodeId: ${tetheredNodeId}`}</p>
        </div>
        <div style={{
            width: 300, height: 50, marginTop: -15, backgroundColor: "blue", color: "white"
        }}
        >
